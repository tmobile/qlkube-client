...
export const basic_request = async (
  connectionParams,
  qlkubeUrl
) => {
  try {
    ...
    const requestOptions = {
      method: 'GET',
      headers: { 'Content-Type': 'application/json', 'connectionparams': connectionParams},
    };
    const qlkRes = await fetch(qlkubeUrl, requestOptions);
    const jsonRes = qlkRes.json();
    return jsonRes;
