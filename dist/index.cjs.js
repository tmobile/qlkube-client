  ...
  var _ref = _asyncToGenerator( /*#__PURE__*/_regeneratorRuntime().mark(function _callee(qlkubeUrl, queryString, clusterUrl, token, queryVariables, onData, onError, onComplete, selfManagedClient) {
    ...
    return _regeneratorRuntime().wrap(function _callee$(_context) {
      while (1) switch (_context.prev = _context.next) {
        case 0:
          client = selfManagedClient ? selfManagedClient : graphqlWs.createClient({
            url: qlkubeUrl
          });
          connectionParams = {
            authorization: "Bearer ".concat(token),
    ...
    return _regeneratorRuntime().wrap(function _callee2$(_context2) {
      while (1) switch (_context2.prev = _context2.next) {
        case 0:
          ...
          _context2.next = 5;
          return axios__default["default"].post(qlkubeUrl, _objectSpread2({}, body), _objectSpread2({}, config));
        case 5:
...
var QLKubeProvider = function QLKubeProvider(_ref) {
  ...
  var _useState = react.useState(qlkubeRouterHostName),
...
exports.useHttpQuery = useHttpQuery;
